                        ...
                        {language === 'zh' ? (
                          <>
                            ...
                            <li>
                              ...
                              ），选择正确 PR 模板；必要时与 <code>upstream/dev</code> 同步（rebase）后继续推送。
                            </li>
                          </>
                        ) : (
                          <>
                      ...
                      <ol className="list-decimal pl-5 space-y-1 text-base">
                        {language === 'zh' ? (
                          <>
                            ...
                            <li>选择正确的 PR 模板（frontend/backend/docs/general）。</li>
                            <li>
                              在 PR 中关联 Issue（示例：
                              <code className="ml-1">Closes #123</code>），PR 目标选择 <code>NoFxAiOS/nofx:dev</code>。
                            </li>
                            <li>
