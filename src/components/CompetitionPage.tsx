...
export function CompetitionPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#000000', color: '#EAECEF' }}>
      <HeaderBar isLoggedIn={isLoggedIn} currentPage="competition" />
          ...
          <div className="space-y-5 animate-fade-in">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-0">
              ...
              <div className="text-left md:text-right w-full md:w-auto">
                ...
                <div className="text-base md:text-lg font-bold" style={{ color: '#F0B90B' }}>
                  {leader?.trader_name}
                </div>
                <div
                          ...
                          <div className="flex items-center gap-2 md:gap-3 flex-wrap md:flex-nowrap">
                            ...
                            <div className="text-right min-w-[70px] md:min-w-[90px]">
                              ...
                              <div
                                ...
                                style={{
                                  color: (trader.total_pnl ?? 0) >= 0 ? '#0ECB81' : '#F6465D',
                                }}
                              >
